...
export function createPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9>(...operations: [PipeOperation<T1, T2>, PipeOperation<T2, T3>, PipeOperation<T3, T4>, PipeOperation<T4, T5>, PipeOperation<T5, T6>, PipeOperation<T6, T7>, PipeOperation<T7, T8>, PipeOperation<T9, T9>]): PipeOperation<T1, T9>;
...
export function createAsyncPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9>(...operations: [AsyncPipeOperation<T1, T2>, AsyncPipeOperation<T2, T3>, AsyncPipeOperation<T3, T4>, AsyncPipeOperation<T4, T5>, AsyncPipeOperation<T5, T6>, AsyncPipeOperation<T6, T7>, AsyncPipeOperation<T7, T8>, AsyncPipeOperation<T9, T9>]): AsyncPipeOperation<T1, T9>;
