...
function dataProviderForAsync(): Array<[Array<any>, (iterable: AsyncIterable<any> | AsyncIterator<any>) => AsyncStream<any>, (stream: AsyncStream<any>) => AsyncStream<any>, any[], any[]]> {
  return [
    [
      [],
