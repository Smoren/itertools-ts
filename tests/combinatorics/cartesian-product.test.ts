...
describe.each([
  ...
  "Combinatorics Cartesian Product Test",
  (input, expected) => {
    it("", () => {
      // Given
      const result = [];
      ...
      // When
      for (const item of combinatorics.cartesianProduct(...input)) {
        result.push(item);
      }
...
describe.each([
  ...
  "Combinatorics Cartesian Product Async Test",
  (input, expected) => {
    it("", async () => {
      // Given
      const result = [];
      ...
      // When
      for await (const item of combinatorics.cartesianProductAsync(...input)) {
        result.push(item);
      }
